...
const messages = {
  tr: {
    ...
    llmQuotaExceeded: 'Yapay zekâ sağlayıcısının kotası veya istek sınırı aşıldı.',
    llmModelUnavailable: 'Yapılandırılmış yapay zekâ modeli sağlayıcıda kullanılamıyor.',
    llmHealthUnverified: 'Executor servisine ulaşılamadığı için yapay zekâ bağlantısı doğrulanamıyor.',
    serviceUnavailable: 'Servise şu anda ulaşılamıyor.',
    ...
    artifactPath: 'Nesne deposu yolu',
    ...
    ingestionInProgressDescription: 'Yeni veriler işleniyor ve analiz için hazırlanıyor.',
    ingestionCompletedDescription: 'En son veriler raporlama ve tahmin çalışmaları için hazır.',
    ingestionStatusDescription: 'Veri varlığının analiz için hazırlık durumu.',
    reporting: 'Raporlama',
    ml: 'Makine öğrenmesi',
    report: 'Rapor',
    enabled: 'Etkin',
  ...
  en: {
    ...
    llmQuotaExceeded: 'The AI provider quota or request limit has been exceeded.',
    llmModelUnavailable: 'The configured AI model is not available from the provider.',
    llmHealthUnverified: 'AI connectivity cannot be verified because the Executor service is unavailable.',
    ...
    artifactPath: 'Object-store path',
    ...
    ingestionInProgressDescription: 'New data is being processed and prepared for analysis.',
    ingestionCompletedDescription: 'The latest data is ready for reporting and prediction work.',
    ingestionStatusDescription: 'Preparation status of this data entity for analysis.',
    reporting: 'Reporting',
    ml: 'Machine learning',
    report: 'Report',
    enabled: 'Enabled',
